                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('ciudads.destroy', $ciudad) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary" href="{{ route('ciudads.show', $ciudad) }}">
                                                        <i class="fa fa-fw fa-eye"></i> {{ __('Show') }}
                                                    </a>

                                                    <a class="btn btn-sm btn-success" href="{{ route('ciudads.edit', $ciudad) }}">
